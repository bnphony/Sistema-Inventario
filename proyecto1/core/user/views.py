...
class UserUpdateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Actualizacion de un Usuario'
        context['entity'] = 'Usuarios'
        context['list_url'] = self.success_url
        context['action'] = 'edit'
        return context
...
class UserChangePasswordView(LoginRequiredMixin, FormView):
    ...
    def get_form(self, form_class=None):
        ...
        form.fields['old_password'].widget.attrs['placeholder'] = 'Ingrese su password antiguo'
        form.fields['new_password1'].widget.attrs['placeholder'] = 'Ingrese su nuevo password'
        form.fields['new_password2'].widget.attrs['placeholder'] = 'Ingrese nuevamente su nuevo password'
        return form
